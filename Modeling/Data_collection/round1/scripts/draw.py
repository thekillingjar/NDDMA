...
def svg_for_dtype(dtype: str, rows: list[dict[str, str]], output: Path) -> None:
    ...
    parts = [
        ...
        f'<text x="{width/2}" y="22" text-anchor="middle">Round1 1D single/multi-core total cycles {dtype}: actual vs predicted</text>',
        ...
        f'<text x="18" y="{top+plot_h/2}" text-anchor="middle" transform="rotate(-90 18 {top+plot_h/2})">total cycles</text>',
